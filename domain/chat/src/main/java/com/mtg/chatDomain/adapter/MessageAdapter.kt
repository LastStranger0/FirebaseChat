package com.mtg.chatDomain.adapter
...
import com.mtg.chatDomain.databinding.ImageMessageBinding
import com.mtg.chatDomain.databinding.MessageBinding
...
class MessageAdapter(
    ...
    inner class MessageViewHolder(private val binding: MessageBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        private fun setTextColor(userName: String?, textView: TextView) {
            if (userName != ANONYMOUS && currentUserName == userName && userName != null) {
                textView.setBackgroundResource(R.drawable.blue_message)
                textView.setTextColor(Color.WHITE)
            } else {
                textView.setBackgroundResource(R.drawable.gray_message)
    ...
    companion object {
        ...
        fun realiseOptions(messagesRef: DatabaseReference) = FirebaseRecyclerOptions.Builder<Message>()
